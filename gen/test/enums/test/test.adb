...
begin
   ...
   Put_Line ("");
   Put_Line ("Testing C mirrors: ");
   Put_Line ("");

   -- The C mirror is passed to C as an int, so it must have the size of one.
   ...
   -- Every literal converts to a C mirror literal with the same name and
