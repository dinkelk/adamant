...
package Word_Serializer is
   ...
   subtype Word_Array_Le_Index is Natural range 0 .. (Serialized_Length - 1);
   subtype Word_Array_Le is Basic_Types.Word_Array_Le (Word_Array_Le_Index);

   -- Word_Array_Be types (big-endian):
   subtype Word_Array_Be_Index is Natural range 0 .. (Serialized_Length - 1);
   subtype Word_Array_Be is Basic_Types.Word_Array_Be (Word_Array_Be_Index);
