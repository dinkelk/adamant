...
-- This is the Interrupt Servicer component. It is attached to an interrupt and sends out an Interrupt_Data_Type every time the interrupt is triggered. This component MUST be made active in order to function properly.
generic
