--------------------------------------------------------------------------------
-- Parameter_Table_Router Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Parameter_Table_Router_Reciprocal;
...
package Component.Parameter_Table_Router.Implementation.Tester is

   use Component.Parameter_Table_Router_Reciprocal;
   ...
   type Instance is new Component.Parameter_Table_Router_Reciprocal.Base_Instance with record
      -- The component instance under test:
      Component_Instance : aliased Component.Parameter_Table_Router.Implementation.Instance;
      -- Connector histories:
...
end Component.Parameter_Table_Router.Implementation.Tester;
