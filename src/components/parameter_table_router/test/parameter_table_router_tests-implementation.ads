--------------------------------------------------------------------------------
-- Parameter_Table_Router Tests Spec
--------------------------------------------------------------------------------

-- Unit tests for the Parameter Table Router component.
package Parameter_Table_Router_Tests.Implementation is

   -- Test data and state:
   type Instance is new Parameter_Table_Router_Tests.Base_Instance with private;
