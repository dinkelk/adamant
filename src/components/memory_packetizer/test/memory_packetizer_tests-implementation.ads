...
private
   ...
   -- This unit test verifies that a zero-length memory dump produces no packets and has no side effects.
   overriding procedure Test_Zero_Length_Memory_Dump (Self : in out Instance);
